...
export function App() {
  ...
  const [concluedTask, setConcluedTask] = useState();
  ...
  function clickCountTask(taskContent: string) {
    const conclued = tasks.filter((task) => {
      return task.contend !== taskContent;
  })
  setConcluedTask(conclued)
}
  return (
    <>
      <div>
        ...
        <main className={styles.wrapper}>
          ...
          <Task
            ...
            onClickCountTask={clickCountTask}
            countTask={countTask}
          />
        </main>
      </div>
